...
class OtpService(private val smsProvider: SmsProvider) {
    ...
    /** Generates and sends a 6-digit OTP. Returns the code in DEV mode only. */
    suspend fun sendOtp(phone: String): String? {
        ...
        transaction {
            OtpCodesTable.insert {
                ...
                it[code] = otp
                it[OtpCodesTable.expiresAt] = expiresAt.toJavaInstant()
 ...
 *
 * MSG91 endpoint: https://api.msg91.com/api/v5/otp
